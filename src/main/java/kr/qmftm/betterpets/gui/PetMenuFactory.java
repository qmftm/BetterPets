...
public final class PetMenuFactory {
     ...
     *
     * <p><b>성장도는 {@link PetType#growsToNextStage} 인 종류에게만 의미가 있다.</b>
     * 그 밖의 종류는 성장도가 아예 오르지 않으므로(={@code GrowthService.growsOverTime})
     * 줄 자체를 뺀다 — 항상 0/max 로만 보이는 줄은 정보가 아니라 소음이다. 포만도는
